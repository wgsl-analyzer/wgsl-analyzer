...
export const fullSource = new lc.RequestType<FullSourceParams, string, void>(
...
export const importTextDocument = new lc.RequestType<ImportTextDocumentParams, unknown, void>(
