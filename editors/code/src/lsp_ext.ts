...
export const discoverTest = new lc.RequestType<
	DiscoverTestParameters,
	DiscoverTestResults,
	void
...
export const runTest = new lc.RequestType<RunTestParameters, void, void>(
	"experimental/runTest",
);
export const abortRunTest = new lc.NotificationType0(
	"experimental/abortRunTest",
);
...
export const changeTestState =
	new lc.NotificationType<ChangeTestStateParameters>(
...
export const ssr = new lc.RequestType<SsrParameters, lc.WorkspaceEdit, void>(
	"experimental/ssr",
);
...
export const fullSource = new lc.RequestType<
	FullSourceParameters,
	string,
	void
...
export const importTextDocument = new lc.RequestType<
	ImportTextDocumentParameters,
	unknown,
	void
