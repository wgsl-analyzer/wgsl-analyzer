...
pub fn gen_function_call_arguments(
    ...
    // ==== Format ====
    // TODO Abstract this "fully multiline if at all multiline" functionality from here, index exprs, template lists, fn declarations, for-loops and wherever it also exists
