...
use syntax::{
    AstNode, AstPtr, SyntaxError, SyntaxNodePointer, TextRange,
...
pub struct UnresolvedMacroCall {
    pub macro_call: InFile<SyntaxNodePointer>,
...
pub struct InactiveCode {
    pub node: InFile<SyntaxNodePointer>,
    pub cfg: CfgExpr,
    pub opts: CfgOptions,
}
...
pub struct NeedMut {
    pub local: Local,
    pub span: InFile<SyntaxNodePointer>,
}
    ...
    pub(crate) fn inference_diagnostic(
        ...
        Some(match d {
            ...
            InferenceDiagnostic::ExpectedFunction { call_expr, found } => {
                ...
                ExpectedFunction {
                    call: call_expr,
                    found: Type::new(db, def, found.clone()),
                }
                .into()
            },
            ...
            InferenceDiagnostic::TypedHole { expr, expected } => {
                ...
                TypedHole {
                    expr,
                    expected: Type::new(db, def, expected.clone()),
                }
                .into()
            },
            ...
            InferenceDiagnostic::CastToUnsized { expr, cast_ty } => {
                ...
                CastToUnsized {
                    expr,
                    cast_ty: Type::new(db, def, cast_ty.clone()),
                }
                .into()
            },
