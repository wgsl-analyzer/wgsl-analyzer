        ...
        if let Some(kind) = support::child_token::<BinaryOpKind>(self.syntax()) {
            ...
            self.syntax()
                ...
                .find_map(|child| match child.kind() {
                    SyntaxKind::ShiftLeft => Some(BinaryOperation::Arithmetic(ArithmeticOperation::Shl)),
                    SyntaxKind::ShiftRight => Some(BinaryOperation::Arithmetic(ArithmeticOperation::Shr)),
                    _ => None,
                })
        }
    }
