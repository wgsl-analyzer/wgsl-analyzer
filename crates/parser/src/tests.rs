...
fn annotation_with_invalid_statement_recover() {
    ...
    let colorA = colA;
        ...
        expect![[r#"
            ...
            error at 16..18: invalid syntax, expected one of: 'const', 'diagnostic', <identifier>
            error at 38..41: invalid syntax, expected one of: '@', '{'
            error at 72..76: invalid syntax, expected one of: 'const', 'diagnostic', <identifier>
