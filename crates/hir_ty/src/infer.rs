...
use hir_def::{
    ...
    expression::{
        ArithmeticOperation, BinaryOperation, Callee, ComparisonOperation, Expression, ExpressionId, Statement, StatementId,
        UnaryOp,
    },
    module_data::Name,
    ...
    fn infer_binary_op(
        ...
        let builtin = match op {
            ...
            BinaryOperation::Arithmetic(op) => match op {
                ArithmeticOperation::BitOr | ArithmeticOperation::BitAnd | ArithmeticOperation::BitXor => {
                ...
                ArithmeticOperation::Add | ArithmeticOperation::Sub | ArithmeticOperation::Modulo => {
...
impl<'db> TyLoweringContext<'db> {
    ...
    pub fn try_lower_ty(
        ...
        let ty_kind = match type_ref {
            ...
            TypeReference::Pointer(ptr) => TyKind::Ptr(Ptr {
                storage_class: ptr.storage_class,
