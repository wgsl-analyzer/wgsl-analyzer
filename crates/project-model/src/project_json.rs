...
/// Roots and packages that compose this Rust project.
...
pub struct Build {
    ...
    /// the label might be something like `//ide/rust/`wgsl-analyzer`:`wgsl-analyzer``.
    ///
    ...
    D: de::Deserializer<'de>,
{
    ...
    PackageName::new(&name).map_err(|err| de::Error::custom(format!("invalid package name: {err:?}")))
}
