...
// Linked in using -Clink-arg=--pre-js=crates/wgsl-analyzer/src/bin/emscripten-io-pre.js
//
...
(() => {
     ...
     * and strips the header before crossing, so there is no framing to parse.
     */
    ...
    /**
     * Hand one of the server's message bodies to `lspStart`'s handler. Backs
     * `lsp_js_write`.
     */
