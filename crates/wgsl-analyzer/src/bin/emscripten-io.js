...
// Linked in via -Clink-arg=--js-library=crates/wgsl-analyzer/src/bin/emscripten-io.js
...
addToLibrary({
    ...
    // thread's own proxied calls from queueing up behind a pending read.
    ...
    // Synchronous rather than async: `Write::write` has to report how many bytes
    // were accepted before it returns, and the host takes all of them at once.
